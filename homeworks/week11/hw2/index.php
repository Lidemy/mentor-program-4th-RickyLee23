<?php
  ...
  on A.category_id = C.id order by A.id desc limit 5");
  $result = $stmt->execute();
...
<div class="container">
  <nav class="nav">
    ...
    <div class="nav__arthor">
      <div class="nav__pic"></div>
    </div>
  </nav>
  <section class="arthor__disc">
    <div>嗨嗨嗨，我是一個喜歡大海的人。</div>
  </section>
  <section class="article__showup">
    ...
    <div class="article">
            ...
            <div class="article__detail">
              ...
              <div class="readmore"><a href="article_view.php?article_id=<?php echo escape($row['id']) ?>">read more ...</a></div>
            </div>
    </div>
    <?php } ?>
